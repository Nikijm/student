...
class UpdateTeacher extends React.Component{
	...
	values._id=this.props.teachers._id
	ajax({
		type:"get",
		url:"/teacher/update",
		data:values,
...
mapPropsToFields(props){
	return {
		name:{value:props.teachers.name},
		age:{value:props.teachers.age},
		sex:{value:props.teachers.sex},
		classes:{value:props.teachers.classes},
		phone:{value:props.teachers.phone}
	}
}
